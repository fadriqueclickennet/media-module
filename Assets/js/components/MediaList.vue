<template>
    <div class="container-fluid sc-table">
                    ...
                    <div class="el-row">
                        <div class="title">
                            ...
                            <div class="media-breadcrumb">
                                <el-breadcrumb separator="/" class="float-sm-right" v-if="! singleModal">
                                    <el-breadcrumb-item>
                        ...
                        >
                            ...
                            <el-table-column label="" width="150">
                                <template slot-scope="scope">
                                    ...
                                    <i :class="`far ${scope.row.fa_icon}`" style="font-size: 38px;" v-if="! scope.row.is_image && ! scope.row.is_folder"></i>
                                    <i class="far fa-folder" style="font-size: 38px;" v-if="scope.row.is_folder"></i>
                                </template>
                            </el-table-column>
